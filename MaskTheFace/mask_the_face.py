...
def masking(abspath):
    ...
    parser.add_argument("--path", type=str, default=abspath,
                        help="Path to either the folder containing images or the image itself",)
    parser.add_argument("--mask_type", type=str, default="surgical",
                        choices=["surgical", "N95", "KN95", "cloth",
                                "gas", "inpaint", "random", "all"],
    ...
    parser.add_argument("--pattern_weight", type=float, default=0.5,
    ...
    parser.add_argument("--code", type=str,
                        ...
                        default="", help="Generate specific formats",)


    parser.add_argument("--verbose", dest="verbose",
                        action="store_true", help="Turn verbosity on")
...
# def mask_all():
    img_folder = r'..\user_image'
    users_name = os.listdir(img_folder)
    for user in users_name:
        user_path = os.path.join(img_folder, user)
        img_ls = glob.glob(user_path + '\*')
        for img in img_ls:
            # print(os.path.abspath(img))
            masking(os.path.abspath(img))

    print('Already mask all the image :)')